...
const PLAN_DETAIL: Record<string, PlanDetailMeta> = {
  'Başlangıç': {
    tagline:    'Operasyonel verimliliğe ilk adımı atın',
    proofLine:  'Taahhüt gerektirmez · Esnek kullanım · Anında aktivasyon',
    formType:   'free',
    ctaLabel:   'Ücretsiz Deneyimi Başlat',
    highlights: [
      'Aylık 100 akıllı randevu kotası',
      'Standart AI sınıflandırma motoru',
      'Otomatik bildirim altyapısı',
    ],
  },
  'Pro': {
    tagline:    'Ölçeklenebilir büyüme için tam otomasyon',
    proofLine:  '30 gün kurumsal deneme · Şeffaf faturalandırma · Kesintisiz geçiş',
    formType:   'pro',
    ctaLabel:   '30 Günlük Ücretsiz Denemeyi Başlat',
    highlights: [
      'Sınırsız randevu ve veri işleme',
      'n8n + G-Workspace ekosistem entegrasyonu',
      'VIP teknik destek ve öncelikli erişim',
    ],
  },
  'Kurumsal': {
    tagline:    'Yüksek ölçekli işletmeler için özel mimari',
    proofLine:  'Stratejik çözüm ortağımız 24 saat içinde sizinle iletişime geçecektir',
    formType:   'enterprise',
    ctaLabel:   'Kurumsal Demo Talebi Oluştur',
    highlights: [
      'Özel API erişimi ve White-label konfigürasyon',
      'Kurumsal SLA ve kesintisiz çalışma garantisi',
      '7/24 Dedike hesap yöneticisi desteği',
    ],
  },
};
