...
/**
 * Floating bar that appears when rows are selected in the appointment table.
 * Positioned at bottom-center with enough z-index to sit above page content
 * but below chat widgets (z-50).
 */
export function BulkActionBar({ count, loading, onCancel, onComplete, onClear }: BulkActionBarProps) {
