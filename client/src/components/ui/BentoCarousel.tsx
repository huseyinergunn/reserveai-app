  ...
  return (
    <motion.div
      className={`rounded-3xl border border-slate-200/70 dark:border-slate-700/40
                  bg-white dark:bg-slate-800/50 ${className}`}
  ...
  return (
    <div className="grid grid-cols-[1fr_110px] grid-rows-2 gap-2 h-[172px]">
      ...
      <Card delay={0.12} className="p-2.5 flex flex-col items-center justify-center gap-0.5 text-center">
        ...
        <p className="text-[9px] text-slate-400">AI yanıt süresi</p>
      </Card>
      ...
      <Card delay={0.22} className="p-2.5 flex flex-col justify-center gap-1.5">
        {[
          ...
          <span key={label} className={`text-[8.5px] font-bold px-2 py-0.5 rounded-full text-center ${cls}`}>
            {label}
          </span>
        ))}
      </Card>
  ...
  return (
    <div className="grid grid-cols-[1fr_110px] grid-rows-2 gap-2 h-[172px]">
      ...
      <Card delay={0.12} className="p-2.5 flex flex-col items-center justify-center gap-0.5 text-center">
        ...
        <p className="text-[9px] text-slate-400">ön rezervasyon</p>
      </Card>
      ...
      <Card delay={0.22} className="p-2.5 flex flex-col justify-center gap-1.5">
        {['09:00', '11:30', '14:00'].map((t, i) => (
          <div key={t} className="flex items-center gap-1.5">
            ...
            <span className="text-[10px] font-mono text-slate-600 dark:text-slate-300">{t}</span>
          </div>
        ))}
      </Card>
    </div>
  ...
  return (
    <div className="grid grid-cols-[1fr_110px] grid-rows-2 gap-2 h-[172px]">
      <Card delay={0} className="row-span-2 p-4 flex flex-col justify-between">
        ...
        <div>
          <p className="text-[9px] font-bold uppercase tracking-widest text-violet-500 mb-1">
            Duygu Analizi
          </p>
          <h3 className="text-xs font-bold text-slate-900 dark:text-white leading-snug">
        ...
        {[
          ...
          <div key={label}>
            <div className="flex justify-between mb-0.5">
              <span className="text-[8px] text-slate-400 capitalize">{label}</span>
      ...
      <Card delay={0.22} className="p-2.5 flex flex-col items-center justify-center gap-0.5 text-center">
        ...
        <p className="text-[9px] text-slate-400">doğruluk</p>
      </Card>
    </div>
  );
}
      ...
      <div className="flex items-center gap-3">
        {SLIDES.map((_, i) => (
          ...
          >
            ...
            />
            {i === active && (
              <span className="text-[10px] font-semibold text-brand-500 dark:text-brand-400 select-none">
                {LABELS[i]}
              </span>
            )}
          </button>
