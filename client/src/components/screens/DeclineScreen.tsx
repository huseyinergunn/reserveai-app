  ...
  return (
    <div className="text-center space-y-6 animate-fade-in">
      ...
      <div className="space-y-2">
        <h2 className="text-2xl font-bold text-slate-900 dark:text-white">E-posta ile İletişime Geçin</h2>
        <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed max-w-sm mx-auto">
          Talebiniz için teşekkür ederiz. Paylaşılan bilgiler doğrultusunda randevu
          yerine doğrudan e-posta yoluyla iletişim kurulması daha uygun olabilir.
          Lütfen talebinizi ve konuyu kısaca belirterek aşağıdaki adrese yazın.
        </p>
      </div>
      ...
      >
        ...
        reserveaiapp@gmail.com adresine yaz
      </a>
